...
def test_MakeHelperModel(num_threads):
    ...
    output_prefix = f'{output_dir}/test.num_threads{num_threads}.helper_model'
    ...
    expected_helper_model = f'{test_resources_dir}/MakeHelperModel/expected/test.num_threads{num_threads}.helper_model.pkl'
    expected_helper_model_combo_matrix = f'{test_resources_dir}/MakeHelperModel/expected/test.num_threads{num_threads}.helper_model_combo_matrix.pkl'
